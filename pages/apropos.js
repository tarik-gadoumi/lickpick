...
export default function Apropos() {
  return (
    <Container>
        <Container sx={{mb: 4}} >
            <Typography align='center' variant='h1'>LINKPICK</Typography>
            <Typography align='center' variant='h1'>LA SOLUTION QUI FACILITE LA RELATION ENTRE ÉTUDIANTS, ENTREPRISES ET ÉCOLES</Typography>
        </Container>
      
    
          <Container  sx={{mb: 8}} >
            <Typography align='center' variant='h2'>Linkpick, c'est aussi une histoire…</Typography>
            <Typography align='center'>Il y a peu de temps encore, nous aussi nous étions étudiants. Nous avons connu les longues sessions de recherche d’informations sur internet, les dizaines de CV personnalisés envoyés et restés sans réponse, les tonnes de documents administratifs à échanger avec l’école, etc...</Typography>
            <Typography align='center'>Bref, une belle perte de temps - et parfois du découragement - alors que nous souhaitons nous concentrer sur l’essentiel : apprendre, identifier des écoles ou des opportunités de stage ou d'alternance, se former et gérer en un seul point tous nos contrats, suivi pédagogique et autres.</Typography>
            <Typography align='center'>C’est donc en pensant aux besoins des étudiants que Linkpick est née, et c’est en y intégrant les besoins des écoles et des entreprises que la solution s’est développée, créant ainsi un environnement vertueux.</Typography>
            <Typography align='center'>Nous sommes convaincus que : </Typography>
            <Typography align='center' sx={{ fontWeight: 'bold' }} > La recherche d’école, de stage et d’alternance peut être grandement facilitée. Les entreprises, écoles et étudiants qui s’engagent dans ce processus peuvent y établir des liens durables de confiance, au bénéfice de tous.</Typography>
            <Typography align='center'>Maintenant, avec Linkpick, nous simplifions et facilitons l'accès aux périodes professionnalisantes des étudiants (stage et alternance) avec <Link>un seul objectif, fluidifier les échanges et les démarches entre les écoles, les étudiants et les entreprises.</Link> </Typography>
            <Typography align='center'>Nous sommes soutenus dans cette démarche par des partenaires du monde tech ou universitaire et améliorons à présent à temps plein notre plateforme de mise en relation.</Typography>
            <Typography align='center'>Nous grandissons avec vous, alors n’hésitez pas à nous contacter pour nous donner votre avis ou nous faire des suggestions ! </Typography>
            <Typography align='center'>À bientôt sur la plateforme,</Typography> 
            <Typography align='center'>Toute l’équipe de Linkpick !</Typography>
          </Container>
            ...
            <Stack direction="row" spacing={2} justifyContent="space-between" alignItems="center" >
                <Card sx={{ height: '50%', display: 'flex', flexDirection: 'column', boxShadow: 0,  justifyContent: 'center' }}>
                  <Box sx={{display: 'flex', justifyContent: 'center'}}>
                    ...
                    <CardContent sx={{ flexGrow: 1 }}>
                        ...
                        <Typography align="center" > Co-fondateur - CTO </Typography>
                    </CardContent>
                    ...
                    <Typography align="center" > Co-fondateur - CEO </Typography>
                  </CardContent>
                  <CardActions sx={{display: 'flex', justifyContent: 'center'}}>
                    <IconButton  aria-label="Linkedin">
                        <LinkedInIcon/>
                ...
                <Card sx={{ height: '50%', display: 'flex', flexDirection: 'column', boxShadow: 0, justifyContent: 'center'  }}>
                  ...
                  <CardContent sx={{ flexGrow: 1 }}>
                    ...
                    <Typography align="center" > CPO </Typography>
                  </CardContent>
                  <CardActions sx={{display: 'flex', justifyContent: 'center'}}>
