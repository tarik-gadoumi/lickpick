          ...
          <Stack spacing={2}>
            <Stack spacing={2}>
              <Typography align="center">
                ...
                <Typography variant="h3">au bout des doigts</Typography>
              </Typography>
              <Typography align="center">
                Linkpick est la première solution qui aide et met en relation
                les étudiants, les entreprises et les écoles, avant, pendant et
                après la formation.
              </Typography>
            </Stack>
...
>>>>>>> 84a7411 (adding company solution)
            ...
            <Box className="box2" sx={{ transform: 'translateY(+500px)' }}>
              <IndexCard
                ...
                description="Validez vos diplômes avec nos 
            ...
            <Box className="box3" sx={{ transform: 'translateX(+500px)' }}>
              <IndexCard
                icon="insights"
                title="Soyez accompagné"
                description="Linkpick est ses partenaires s'engagent 
      ...
      >
        <Stack spacing={3} width={{ xs: '90%', md: '40%' }} ml={5}>
          <Container
            ...
            sx={{ transform: 'translateX(-1000px)' }}
          >
            <Typography
              className="typo"
              sx={{ transform: 'translateY(-1000px)' }}
              variant="h4"
              mb={3}
            >
              En quelques clics ...
            ...
            <Stack spacing={3}>
              <IndexCardHorizon
                icon="person"
                title="Plus de CV,"
                subtitle="partagez votre profil"
                description="Validez vos diplômes avec nos entreprises
            partenaires qui proposent des stages ou des
            alternances toute l'année."
              />
              <IndexCardHorizon
                icon="handDown"
                title="Des organismes,"
        ...
        <Stack
          width="60%"
          sx={styles.boxIllustration}
          className="boxContainer2"
        >
          <Box className="bonhomme" sx={{ transform: 'translateX(1000px)' }}>
            <img height="auto" width="50%" src="/bonhomme.png"></img>
          </Box>
        </Stack>
      </Stack>
        ...
        <Container className="boxContainer3">
          <Stack sx={{ maxWidth: { xs: '90%', md: '60%' } }}>
            <Typography align="center" variant="h5">
              Concentrez-vous sur l'essentiel avec Linkpick
            </Typography>
            <Typography align="center">
              La solution Linkpick est conçue pour piloter facilement et au même
              endroit sa vie étudiante. Gagnez du temps pour les échanges qui
              comptent vraiment.
            </Typography>
          </Stack>
          <Box className="dashboard" sx={{ transform: 'translateY(+1000px)' }}>
            <img width="100%" src="/dashboard.png"></img>
          </Box>
        </Container>
      </Stack>
<<<<<<< HEAD
...
=======
      <Stack className="boxContainer4" sx={{ overflow: 'hidden' }}>
        ...
        <Box
          className="preinscription"
          sx={{ transform: 'translateY(+500px)' }}
        >
          <Preinscription />
        </Box>
>>>>>>> 84a7411 (adding company solution)
